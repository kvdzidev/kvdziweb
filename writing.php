...
<body>
    ...
    <div class="content">
        <p style="font-size: 50px; font-weight: bold; margin-top: 50px;">On this page you will find some of my writings!</p><br>
        <p>I have over 1 year of job experience in writing scripts - either for youtube/tiktok/instagram videos, <br>
            documentaries, criminals, youtube content videos
            , translations, fun fact type videos. <br>I'm open to any other type of writing, send me a private message and we'll discuss it.</p>
            <div class="flexi">
                <div class="flexi">
                    <img src="writings.png" id="siz" style="box-shadow: blue 0px 0px 0px 2px inset, rgb(255, 255, 255) 10px -10px 0px -3px, rgb(31, 193, 27) 10px -10px, rgb(255, 255, 255) 20px -20px 0px -3px, rgb(255, 217, 19) 20px -20px, rgb(255, 255, 255) 30px -30px 0px -3px, rgb(255, 156, 85) 30px -30px, rgb(255, 255, 255) 40px -40px 0px -3px, rgb(255, 85, 85) 40px -40px; margin-right: 90px; width: 160px; margin-top: 135px;">
                    <img src="arrow-forward.svg" id="siz" style="margin-right: 50px; margin-top: 115px;">
                    <a href="docs.google.com/document/d/15bbgyPj3lf3KCDZII56mG78C-kORqqgRpgTzGrF05s4/"><img src="docslogo.svg" id="siz"></a>
                </div>
            </div>
